...
def setDefaultRoute(file_station):
...
def main():
    station_dic = {}
    file_station = pd.read_excel("./SeoulMetro_StationSpacing(202003)_edit.xlsx")
    file_transfer = pd.read_excel("./SeoulMetro_TransferStation_Distance_and_NecessaryTime(2019).xlsx")

    station_dic = setDefaultRoute(file_station)
    station_dic = setTransferRoute(station_dic, file_transfer)

    return station_dic

#    for i in station_dic:
#        print(i, station_dic[i])
