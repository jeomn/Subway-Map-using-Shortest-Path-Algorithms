...
def main():
    ...
    file_station = pd.read_excel(
        "C:\\Users\\jeomn\\sts_workspace\\MetroRoute\\src\\main\\resources\\static\\SeoulMetro_StationSpacing.xlsx")
    file_transfer = pd.read_excel(
        "C:\\Users\\jeomn\\sts_workspace\\MetroRoute\\src\\main\\resources\\static\\SeoulMetro_TransferStation_Distance_and_NecessaryTime.xlsx")
